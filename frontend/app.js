  ...
  "members": [
    {
      ...
      "bio": "Учусь в AIU (Astana IT University). Стажировался в АО «Казахтелеком» (сетевая диагностика, обработка инцидентов), работаю с Flask/FastAPI, T-SQL, Python. Вне учёбы слушаю западную музыку (Kanye West и похожее) и играю на гитаре.",
